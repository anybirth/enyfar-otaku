...
class Member(models.Model):
    ...
    line_id = models.CharField(_('LINE ID'), max_length=255, blank=True)
    twitter_id = models.CharField(_('Twitter ID'), max_length=255, blank=True)
    instagram_id = models.CharField(_('Instagram ID'), max_length=255, blank=True)
    facebook_id = models.CharField(_('Facebook ID'), max_length=255, blank=True)
    whatsapp_id = models.CharField(_('WhatsApp ID'), max_length=255, blank=True)
    kik_id = models.CharField(_('KIK ID'), max_length=255, blank=True)
